...
# Moved to _types_extras.py for line-limit compliance; re-exported here.
from ._types_extras import BrainSettingsDict, QualityThresholdsDict, ResearchBudgetDict
