...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ToolDefinition": ("brain_alpha_ops.agent_tool_registry", "ToolDefinition"),
    "ToolRegistry": ("brain_alpha_ops.agent_tool_registry", "ToolRegistry"),
    "default_tool_registry": ("brain_alpha_ops.agent_tool_registry", "default_tool_registry"),
    "resolve_tool_name": ("brain_alpha_ops.agent_tool_registry", "resolve_tool_name"),
    "tool_aliases": ("brain_alpha_ops.agent_tool_registry", "tool_aliases"),
    "tool_definitions": ("brain_alpha_ops.agent_tool_registry", "tool_definitions"),
