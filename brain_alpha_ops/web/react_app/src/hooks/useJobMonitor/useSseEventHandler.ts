/**
 * useSseEventHandler + useStatusWatchdog — SSE event handling, retry state,
 * and the status-polling watchdog for the non-submission pipeline monitor.
 *
 * Originally split across `useSseEventHandler.ts`, `useSseRetryState.ts`
 * (deprecated, absorbed here), and `useStatusWatchdog.ts` (merged here).
 */

import { useCallback, useEffect, useRef, useState } from 'react';
import type { Dispatch, SetStateAction } from 'react';
import { resolveJobEventState, classifyJobState, jobStatusMessage } from '@/helpers/runPayload';
import {
  isSSECandidateData,
  type SSEEvent,
  type JobStatus,
...
import { SSE_RETRY_DELAYS, SSE_MAX_RETRIES, type NotifyFn } from './index';

// ──────────────────────────────────────────────────────────────────────────
// useSseEventHandler (with retry state absorbed from useSseRetryState)
// ──────────────────────────────────────────────────────────────────────────
...
// ──────────────────────────────────────────────────────────────────────────
// useStatusWatchdog — periodic /api/production-validation/status polling
// ──────────────────────────────────────────────────────────────────────────
