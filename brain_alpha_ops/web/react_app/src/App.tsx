...
function AppContent() {
  ...
  const {
    activeView, selectedCandidate, credentials, sidebarOpen, shortcutsHelpOpen,
    toasts, notify, dismissToast, jobState,
    connected, contextFresh, phaseApiStatus, managedCredentialsAvailable,
    officialOpsAutoStart, phaseData,
    phaseState, steps, currentPhase,
    sidebarPhases, sidebarBadges,
    setActiveView, setSidebarOpen, setShortcutsHelpOpen,
    handleTogglePhase, handleNavigate, handleConnectionTested,
    ...
    handleMobileNavigate, openScoring,
  } = appState;
  ...
  const viewProps: RenderViewProps = useMemo(() => ({
    ...
    handleOfficialSyncCompleted, handleOfficialReconnectRequested,
    handleCandidatePoolUpdated, handleLocalSessionLoggedOut,
    appState.setCredentials, appState.setOfficialOpsAutoStart,
  ]);
      ...
      <ToastProvider>
        <div className="app-shell">
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              {jobState.running && (
                <button
                  ...
                  style={{ fontFamily: "var(--font-mono)", fontSize: 10, cursor: "pointer", border: "none" }}
              ...
              <Tooltip content={theme === "dark" ? "切换到浅色模式" : "切换到深色模式"} placement="bottom">
                <button
                  type="button"
          ...
          <main className="app-main" id="main-content" tabIndex={-1}>
            <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[999] focus:px-4 focus:py-2 focus:bg-accent focus:text-text-inverse focus:rounded-md focus:font-medium focus:text-sm">
              跳到主内容
            </a>
