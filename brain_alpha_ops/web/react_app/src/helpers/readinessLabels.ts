const READINESS_REASON_LABELS: Record<string, string> = {
  ...
  candidate_family_missing_cloud_similarity: '候选族缺少云端相似度证据',
  candidate_family_missing_scientific_audit: '候选族缺少科学审计证据',
  candidate_family_invalid_scientific_audit_schema: '候选族科学审计版本异常',
  candidate_family_incomplete_scientific_audit: '候选族科学审计证据不完整',
  candidate_family_scientific_audit_test_feedback_used: '候选族科学审计含测试反馈',
  candidate_family_scientific_audit_submit_boundary_breached: '候选族科学审计提交边界异常',
  candidate_family_official_context_proof_failed: '候选族官方上下文证明未通过',
  candidate_family_not_submit_band: '候选族尚未进入复核带',
  candidate_family_lifecycle_history_blocked: '候选族存在历史归档风险',
  candidate_family_lifecycle_history_failed: '候选族存在历史返工风险',
  ...
  lifecycle_history_failed: '历史生命周期要求返工',
  latest_candidate_high_cloud_similarity: '最新候选云端相似度过高',
  latest_candidate_local_backtest_failed: '最新候选本地回测未通过',
  ...
  optimize: '需要继续优化',
  production_decision_blocked: '生产决策仍阻断',
  production_decision_lifecycle_blocked: '生产决策含历史生命周期阻断',
  research_only: '仅限研究',
  score_below_official_simulation_threshold: '未达到官方仿真分数门槛',
  submit_candidate: '提交前复核候选',
  latest_candidate_lifecycle_history_blocked: '最新候选存在历史归档风险',
  latest_candidate_lifecycle_history_failed: '最新候选存在历史返工风险',
  latest_candidate_lifecycle_decision_blocked: '最新候选生产决策含历史阻断',
  latest_candidate_production_decision_blocked: '最新候选生产决策仍阻断',
  latest_candidate_missing_scientific_audit: '最新候选缺少科学审计证据',
  latest_candidate_invalid_scientific_audit_schema: '最新候选科学审计版本异常',
  latest_candidate_incomplete_scientific_audit: '最新候选科学审计证据不完整',
  latest_candidate_scientific_audit_test_feedback_used: '最新候选科学审计含测试反馈',
  latest_candidate_scientific_audit_submit_boundary_breached: '最新候选科学审计提交边界异常',
  latest_candidate_official_context_proof_failed: '最新候选官方上下文证明未通过',
};
...
export function readinessProductionGapLabel(
...
const READINESS_NEXT_ACTION_LABELS: Record<string, string> = {
