    ...
    <div className="panel mb-4" role="region" aria-label="提交状态流转">
      ...
      <div className="panel-body-padded">
              ...
              <div style={{ textAlign: 'center', minWidth: 100 }}>
                <div
                  style={{
                    ...
                    border: `1.5px solid ${
                      stage.status === 'complete'
                        ? 'var(--color-status-complete-border)'
                        : stage.status === 'active'
                          ? 'var(--color-status-active-text)'
                          : stage.status === 'blocked'
                            ? 'var(--color-status-blocked-border)'
                            : 'var(--color-text-dim)'
                    }`,
                    color:
                      stage.status === 'complete'
                        ? 'var(--color-status-complete-text)'
                        : stage.status === 'active'
                          ? 'var(--color-status-active-text)'
                          : stage.status === 'blocked'
        ...
        <p
          ...
          style={{ borderTop: '0.5px solid var(--color-border-default)', paddingTop: 8 }}
        >
