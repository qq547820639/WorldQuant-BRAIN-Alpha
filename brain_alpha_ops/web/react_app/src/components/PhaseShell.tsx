  ...
  return (
    ...
    >
      ...
      {isBlocked && (
        <div
          style={{
            ...
            borderRadius: 6,
            border: '1px solid',
            borderColor: 'var(--color-panel-negative-border)',
      ...
      <div
        ...
        style={isBlocked ? { opacity: 0.45, filter: 'grayscale(0.3)' } : undefined}
      >
        {children}
      </div>
    </div>
