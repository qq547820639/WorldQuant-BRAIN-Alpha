...
function saveTrendData(key: string, data: TrendData[]): void {
  try {
    ...
    console.warn('Dashboard: localStorage full or unavailable');
  }
}
...
export function syncTrendToBackend(
  candidates: number,
  submissions: number,
  cycles: number = 0
): void {
...
export const TREND_KEY = {
  CANDIDATES: TREND_KEY_CANDIDATES,
  SUBMISSIONS: TREND_KEY_SUBMISSIONS,
} as const;
