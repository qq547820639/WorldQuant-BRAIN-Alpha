...
export function cloudBadgeTotal(payload?: { count?: number; total?: number; summary?: Record<string, unknown> } | null): number | undefined {
...
export function topbarConnectionStatus({ connected, contextFresh, phaseStatus = "ready" }: { connected: boolean; contextFresh: boolean; phaseStatus?: PhaseApiStatus }) {
