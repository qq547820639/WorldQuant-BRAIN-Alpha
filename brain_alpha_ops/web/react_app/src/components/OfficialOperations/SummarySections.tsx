...
export default function SummarySections({ readiness, displaySyncStatus, onNavigateToCandidates }: Props) {
  ...
  const officialContextSummary = officialContextSummaryMessage(displaySyncStatus as import("@/types").JobStatus | null);
    ...
    <section className="grid gap-4 lg:grid-cols-3">
      ...
      <section className="rounded-md border border-border-subtle bg-[oklch(0.100_0.007_45)] p-4">
        ...
        <dl className="mt-3 grid grid-cols-3 gap-3 text-sm">
          ...
          <SummaryMetric label="算子" value={contextSummaryField(displaySyncStatus as import("@/types").JobStatus | null, "operators_count")} />
          <SummaryMetric label="数据集" value={contextSummaryField(displaySyncStatus as import("@/types").JobStatus | null, "datasets_count")} />
        </dl>
