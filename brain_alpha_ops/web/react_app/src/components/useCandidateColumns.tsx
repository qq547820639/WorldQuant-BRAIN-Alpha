...
export function useCandidateColumns(params: UseCandidateColumnsParams) {
  ...
  const allSelected =
    params.allCurrentPageIds.length > 0 &&
  ...
  const renderHeader = useCallback(
    () => (
      <tr>
        ...
        <th style={{ width: '2rem' }} aria-label="收藏">
          ⭐
        </th>
    ...
    [
      allSelected,
      params.allCurrentPageIds,
      params.hasActions,
      params.onSort,
      params.onToggleSelectAll,
      params.sortAsc,
      params.sortKey,
    ]
  );
  ...
  const renderRow = useCallback(
    ...
    [
      params.checkResults,
      params.hasActions,
      params.canShowRowActions,
      params.showProductionControls,
      params.candidateWorkflowBusy,
      params.checkingAlphaId,
      params.onScore,
      params.onSimulate,
      params.onCheck,
      params.selectedIds,
      params.onToggleSelect,
    ]
  );
