"""Error catalogue and status classification constants.

Shared Web console error definitions and status label/set constants used by
the contract and classification helpers in this subpackage.
"""
