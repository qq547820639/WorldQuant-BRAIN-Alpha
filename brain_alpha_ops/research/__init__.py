...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "MarketDataCache": ("brain_alpha_ops.research.market_data_cache", "MarketDataCache"),
    "VectorizedMarketDataStore": ("brain_alpha_ops.research.market_data_vector", "VectorizedMarketDataStore"),
    "ParameterSearchService": ("brain_alpha_ops.research.parameter_search", "ParameterSearchService"),
    "ParameterSearchOrchestrator": ("brain_alpha_ops.research.search_orchestrator", "ParameterSearchOrchestrator"),
    "AlertDeliveryService": ("brain_alpha_ops.research.alerting", "AlertDeliveryService"),
    "AlertRouter": ("brain_alpha_ops.research.alerting", "AlertRouter"),
    "ParallelBacktestExecutor": ("brain_alpha_ops.research.parallel_backtest", "ParallelBacktestExecutor"),
    "ParallelBacktestPlanner": ("brain_alpha_ops.research.parallel_backtest", "ParallelBacktestPlanner"),
