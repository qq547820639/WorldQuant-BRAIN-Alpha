...
class PipelineSnapshotMixin:
    ...
    def _snapshot_state(self) -> PipelineSnapshotState:
        return PipelineSnapshotState(
            ...
            official_retry_remaining_seconds=self.services.runtime._official_retry_remaining_seconds(),
            ...
            auto_calibrator_status=(
                getattr(self.auto_calibrator, "status", None)
                or ("ready" if not hasattr(self.auto_calibrator, "calibrate") else "active")
            ),
