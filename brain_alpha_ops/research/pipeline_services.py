...
class PipelineServiceFactoryMixin:
    ...
    def _backtest_submission_service(self) -> BacktestSubmissionService:
        return BacktestSubmissionService(
            ...
            poll_interval=self.services.backtest_flow._poll_interval_seconds,
            halt_official_calls=self.services.runtime._halt_official_calls,
            event=self.services.runtime._event,
        )
    ...
    def _backtest_finalization_service(self) -> BacktestFinalizationService:
        return BacktestFinalizationService(
            ...
            try_auto_submit=self.services.submission_gate._try_auto_submit,
            should_remove_after_official_result=self.services.legacy_simulation._should_remove_after_official_result,
            event=self.services.runtime._event,
    ...
    def _official_workflow_service(self) -> OfficialWorkflowService:
        return OfficialWorkflowService(
            validate_for_open_backtest_slots=self.services.official_validation._validate_for_open_backtest_slots,
            fill_backtest_slots=self.services.backtest_flow._fill_backtest_slots,
            poll_due_backtests=self.services.backtest_flow._poll_due_backtests,
    ...
    def _secondary_fusion_service(self) -> SecondaryFusionService:
        return SecondaryFusionService(
            ...
            record_lifecycle=self.services.runtime._record_lifecycle,
            event=self.services.runtime._event,
            retry_count=self.services.backtest_flow._simulation_retry_count,
        )
