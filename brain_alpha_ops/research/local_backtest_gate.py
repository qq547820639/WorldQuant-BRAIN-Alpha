"""Shared local synthetic prefilter gate helpers for candidate prefilters.

NOTE: These gates use synthetic data, not real historical market data.
Results are approximate prefilter scores only.
"""
