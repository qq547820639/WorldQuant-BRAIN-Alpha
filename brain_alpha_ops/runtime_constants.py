...
# Deprecated default classes retained for backward compatibility with
# ``tests/test_runtime_constants.py``. Target removal: v0.4 (2026-Q3).
# Use ``ScoringConfig`` and ``ResearchBudget`` from ``config_models`` instead.
