...
- Generated: 2026-05-28T05:24:40.042947+00:00
...
- History replay: capability=ready, history_count=6, latest_comparison=True
...
- [x] Checkpoint/run-history analytics are wired (history_count=6, comparison=True).
...
- Browser-level recheck completed in the visible browser for the favicon / connection form / lifecycle label polish that landed after the prior E2E run.
...
- **P2 UX clarity**: Keep the official expression-validation and official simulation badges distinct in both the candidate table and detail modal; this mapping has been rechecked in the visible browser.
