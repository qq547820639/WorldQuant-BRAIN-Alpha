...
* ``python scripts/check_review_gap_closure_tracker.py`` still works as a
...
Note: when both ``check_review_gap_closure_tracker.py`` and
``check_review_gap_closure_tracker/__init__.py`` exist, Python resolves
``scripts.check_review_gap_closure_tracker`` to the package directory. The
...
from scripts.check_review_gap_closure_tracker import main  # noqa: E402,F401
