...
match-actionability predicates are inlined below (formerly the
``scripts.scan_sensitive_artifacts`` subpackage, Workstream F3.9).
"""
...
# ═══════════════════════════════════════════════════════════════════════
# Patterns, constants, and match-actionability helpers
# (formerly ``scripts/scan_sensitive_artifacts/_patterns.py``)
# ═══════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════
# Scan logic: file iteration, scanning, and CLI entry
# (formerly ``scripts/scan_sensitive_artifacts/_scanners.py``)
# ═══════════════════════════════════════════════════════════════════════
