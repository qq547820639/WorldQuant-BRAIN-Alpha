...
PyInstaller.__main__.run([
    ...
    "--hidden-import=brain_alpha_ops.web.dispatch.web_http_handler",
    "--hidden-import=brain_alpha_ops.web.dispatch.web_routes",
    "--hidden-import=brain_alpha_ops.web.dispatch.web_handler_dispatch",
