...
REACT_CONTRACT_COVERAGE = {
    ...
    "components/CandidateTableSubComponents/CandidateTableDisplay.tsx": "React component (candidate table sub components submodule): candidate table display",
    "components/CandidateTableSubComponents/CandidateTablePrimitives.tsx": "React component (candidate table sub components submodule): candidate table primitives",
    ...
    "components/ConfigPanel/ConfigPanelCredentials.tsx": "React component (config panel submodule): credentials section",
    "components/ConfigPanel/ConfigPanelSections.tsx": "React component (config panel submodule): config form sections",
    ...
    "components/OfficialOperations/OfficialDisplayComponents.tsx": "React component (official operations submodule): display components",
    "components/OfficialOperations/OfficialSummaryComponents.tsx": "React component (official operations submodule): summary components",
    "components/OfficialOperations/index.ts": "React component (official operations submodule): index",
    "components/OfficialOperations/officialOperationsCore.ts": "official operations core helpers, constants, and formatters",
    "components/OfficialOperations/officialSyncOverview.ts": "official sync overview state and context cache",
    "components/OfficialOperations/officialSyncProgress.ts": "official sync progress tracking and stages",
    ...
    "components/OfficialOperations/useSyncControl.ts": "React hook (official operations submodule): sync control",
    "components/OfficialOperations/useSyncWorkflow.ts": "React hook (official operations submodule): sync workflow",
    ...
    "components/ScoringPanel/ScoringPanelGates.tsx": "React component (scoring panel submodule): gates display",
    "components/ScoringPanel/ScoringPanelHeader.tsx": "React component (scoring panel submodule): header",
    ...
    "components/SubmissionPanel.tsx": "React component: submission panel",
    ...
    "hooks/useAppState/useAppState.tsx": "React hook (use app state submodule): app state context and provider",
    "hooks/useAppState/useAppStateEffects.ts": "React hook (use app state submodule): side effects",
    "hooks/useAppState/useAppStateState.ts": "React hook (use app state submodule): base state and handlers",
    ...
    "types/allTypes.ts": "merged TypeScript type definitions (api, scoring, candidate, config, cloud, ui, errors + type guards)",
    "types/index.ts": "barrel re-export for TypeScript type definitions",
    "utils/errors.ts": "error handling helpers (ApiError, ValidationError, logError, formatErrorForUser, reportIgnoredError)",
    "utils/helpers.ts": "runtime helpers (CSRF/stream tokens, resume state, starred candidates, debounce, backtest slots)",
    "utils/index.ts": "barrel re-export for utility helpers",
...
def test_frontend_runtime_modules_render_state_and_interaction_contracts():
    ...
    candidate_sort_header = _source("components/CandidateTableSubComponents/CandidateTablePrimitives.tsx")
...
def test_app_ux_orchestrator_has_tested_navigation_empty_and_busy_contracts():
    ...
    handlers = _source("hooks/useAppState/useAppStateEffects.ts")
